...
('user1', 'John', 'Doe', 'john.doe1@example.com', 'password1', '1234567890', '2025-03-18', 'user', 1),
('user2', 'Jane', 'Smith', 'jane.smith2@example.com', 'password2', '1234567891', '2025-03-18', 'user', 2),
('user3', 'Alice', 'Johnson', 'alice.johnson3@example.com', 'password3', '1234567892', '2025-03-18', 'user', 2),
('user4', 'Bob', 'Williams', 'bob.williams4@example.com', 'password4', '1234567893', '2025-03-18', 'user', 3),
('user5', 'Charlie', 'Brown', 'charlie.brown5@example.com', 'password5', '1234567894', '2025-03-18', 'librarian', 4),
('user6', 'David', 'Davis', 'david.davis6@example.com', 'password6', '1234567895', '2025-03-18', 'user', 2),
('user7', 'Emily', 'Miller', 'emily.miller7@example.com', 'password7', '1234567896', '2025-03-18', 'user', 7),
('user8', 'Frank', 'Wilson', 'frank.wilson8@example.com', 'password8', '1234567897', '2025-03-18', 'librarian', 8),
('user9', 'Grace', 'Moore', 'grace.moore9@example.com', 'password9', '1234567898', '2025-03-18', 'user', 5),
('user10', 'Henry', 'Taylor', 'henry.taylor10@example.com', 'password10', '1234567899', '2025-03-18', 'user', 6),
('user11', 'Isabel', 'Anderson', 'isabel.anderson11@example.com', 'password11', '1234567800', '2025-03-18', 'user', 8),
('user12', 'Jack', 'Thomas', 'jack.thomas12@example.com', 'password12', '1234567801', '2025-03-18', 'librarian', 8),
('user13', 'Kimberly', 'Jackson', 'kimberly.jackson13@example.com', 'password13', '1234567802', '2025-03-18', 'user', 2),
('user14', 'Liam', 'White', 'liam.white14@example.com', 'password14', '1234567803', '2025-03-18', 'user', 3),
('user15', 'Mia', 'Harris', 'mia.harris15@example.com', 'password15', '1234567804', '2025-03-18', 'user', 1),
('user16', 'Noah', 'Clark', 'noah.clark16@example.com', 'password16', '1234567805', '2025-03-18', 'user', 1),
('user17', 'Olivia', 'Lewis', 'olivia.lewis17@example.com', 'password17', '1234567806', '2025-03-18', 'user', 2),
('user18', 'Peter', 'Walker', 'peter.walker18@example.com', 'password18', '1234567807', '2025-03-18', 'user', 7),
('user19', 'Quinn', 'Hall', 'quinn.hall19@example.com', 'password19', '1234567808', '2025-03-18', 'user', 8),
